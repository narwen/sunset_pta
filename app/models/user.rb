class User < ActiveRecord::Base
  ...
  def User.unique_chairs
    chair_assignments = Assignment.find(:all, :conditions => [ "duty_id = ?", Duty.find_by_name("Chair").id], :group => "user_id, assignments.id, assignments.committee_id, assignments.duty_id, assignments.created_at, assignments.updated_at")
    uchairs = []
